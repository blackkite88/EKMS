...
- "action": the user asks to DO something — generate an RCA report, create a work order, generate a compliance report, or notify/alert a team. Set "action" to one of: generate_rca_report, create_work_order, generate_compliance_report, draft_notification. Set "target" to the equipment tag or subject if identifiable.
